...
def Fitness3():
 ...
 #  os.system(path) 
    while not os.path.exists("C:\Users\Frank\Desktop\\Bullet/fits.dat") :
        time.sleep(0.5); 
    os.remove("C:\Users\Frank\Desktop\\Bullet/fits.dat")
...
for i in range(numGenerations):
    ...
    #print "child ", child
    Fitness3_Get(child)
    fitnessFile = open("C:\Users\Frank\Desktop\Bullet/fitnesss.dat", "r")
    fitnessValue = float(fitnessFile.read(10))
    fitnessFile.close()
