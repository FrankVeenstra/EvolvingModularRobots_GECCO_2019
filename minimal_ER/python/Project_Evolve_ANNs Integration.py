...
def Fitness3_Get(synapses):
    ...
    os.system(path);
    file = open("C:\Users\Frank\Desktop\Bullet Dynamics Engine\Integration/weights.dat", "w")
    file.write("synapses ,")
...
def Fitness3():
    os.system("C:\Users\Frank\Desktop\Bullet Dynamics Engine\Integration/fits.dat") 
    while not os.path.exists("fits") :
        time.sleep(0.5); 
    sys.exit(0);
 #   os.remove("C:\Users\Frank\Desktop\Bullet Dynamics Engine\Integration/fits.dat")
